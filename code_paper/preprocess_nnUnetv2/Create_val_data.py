...
Path_to_test_data='/home/mleeuwen/DATA/nnUnet_data/Dataset001_Bonesegmentation/imagesvalidation'

if os.path.isdir(Path_to_test_data)==False:
    os.mkdir(Path_to_test_data)

Original_data="/home/mleeuwen/DATA/TSv3_Selection/Osteolytic_validation_10mm"
Path_to_yolo_test='/home/mleeuwen/Deep learning Models/Total_bone_detector/datasets/Axial_BSv2_v5/val/images'
