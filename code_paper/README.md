...
To provide more details on the data that we used to trian the YOLOV5 models, we also provide an [overview](https://github.com/MartijnPeterVanLeeuwen/BoneDetection/blob/main/code_paper/Datasplit_TotalSegmentator.xlsx) of the inlcuded scans, in combination with a label that shows for what dataset they were used. 
